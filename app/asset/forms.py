...
class AddProductForm(FlaskForm):
    ...
    options = [('NRU','NRU'),('COMPUTER','COMPUTER'),('CABLEKIT','CABLEKIT'),('CARD','CARD'),('FANKIT','FANKIT'),('CAMERA','CAMERA'),('PB','PB-UNIT'),('POWERADAPTOR','POWER ADAPTOR'),('DINRAIL','DINRAIL'),('WALLMOUNT','WALLMOUNT'),('DUMPINGBRACKET','DUMPINGBRACKET'),('GPU','GPU')]
